...
path_to_file = 'theory_400_hyperopt_10_rep_1000_trials_Sept_14/nnfit/replica_1/tries.json'
...
axs[0, 0].set_title('Contour Plot of Average Hyper Loss: 10 replicas & theory 400')
